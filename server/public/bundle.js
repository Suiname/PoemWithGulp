...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  function App() {
	    ...
	    _this.state = { logged: false, loggedHeader: false, users: [], chatBoxes: [], chatOpen: false, userMessage: '', PrvMsgData: [], room: false, modal: false, user: '', roomUsers: {}, txtvalue: '' };
	    _this.textType = _this.textType.bind(_this);
	    return _this;
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'form',
	            null,
	            _react2.default.createElement('input', { type: 'textarea', value: this.state.txtvalue, onChange: this.textType })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
